...
- Every mutation inserts a row into `contributions` with `userId`, `action`, `targetId`, and optional `metadata`. See [admin overview](../admin-api.md) for action names and payload format.

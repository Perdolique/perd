...
const groupDefinitions: ReferenceSeedDefinition[] = [
  {
    name: 'Shelter',
    seedSlug: 'group-seed-1',
    slug: 'shelter'
  },
  {
    name: 'Sleep',
    seedSlug: 'group-seed-2',
    slug: 'sleep'
  },
  {
    name: 'Packing',
    seedSlug: 'group-seed-3',
    slug: 'packing'
  },
  {
    name: 'Cooking',
    seedSlug: 'group-seed-4',
    slug: 'cooking'
  },
  {
    name: 'Water',
    seedSlug: 'group-seed-5',
    slug: 'water'
  },
  {
    name: 'Clothing',
    seedSlug: 'group-seed-6',
    slug: 'clothing'
  },
  {
    name: 'Footwear',
    seedSlug: 'group-seed-7',
    slug: 'footwear'
  },
  {
    name: 'Navigation',
    seedSlug: 'group-seed-8',
    slug: 'navigation'
  },
  {
    name: 'Lighting',
    seedSlug: 'group-seed-9',
    slug: 'lighting'
  },
  {
    name: 'Electronics',
    seedSlug: 'group-seed-10',
    slug: 'electronics'
  },
  {
    name: 'Trekking',
    seedSlug: 'group-seed-11',
    slug: 'trekking'
  },
  {
    name: 'Safety',
    seedSlug: 'group-seed-12',
    slug: 'safety'
  }
]
...
const categoryDefinitions: ReferenceSeedDefinition[] = [
  {
    name: 'Sleeping Bags',
    seedSlug: 'category-seed-1',
    slug: 'sleeping-bags'
  },
  {
    name: 'Sleeping Pads',
    seedSlug: 'category-seed-2',
    slug: 'sleeping-pads'
  },
  {
    name: 'Tents',
    seedSlug: 'category-seed-3',
    slug: 'tents'
  },
  {
    name: 'Stoves',
    seedSlug: 'category-seed-4',
    slug: 'stoves'
  },
  {
    name: 'Water Filters',
    seedSlug: 'category-seed-5',
    slug: 'water-filters'
  }
]
...
const brandDefinitions: ReferenceSeedDefinition[] = [
  {
    name: 'Therm-a-Rest',
    seedSlug: 'brand-seed-1',
    slug: 'therm-a-rest'
  },
  {
    name: 'Nemo',
    seedSlug: 'brand-seed-2',
    slug: 'nemo'
  },
  {
    name: 'Sea to Summit',
    seedSlug: 'brand-seed-3',
    slug: 'sea-to-summit'
  },
  {
    name: 'MSR',
    seedSlug: 'brand-seed-4',
    slug: 'msr'
  },
  {
    name: 'Big Agnes',
    seedSlug: 'brand-seed-5',
    slug: 'big-agnes'
  },
  {
    name: 'Zpacks',
    seedSlug: 'brand-seed-6',
    slug: 'zpacks'
  },
  {
    name: 'Gossamer Gear',
    seedSlug: 'brand-seed-7',
    slug: 'gossamer-gear'
  },
  {
    name: 'Enlightened Equipment',
    seedSlug: 'brand-seed-8',

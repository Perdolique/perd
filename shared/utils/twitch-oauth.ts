const twitchOAuthMessages = {
  ...
  alreadyLinked: 'Twitch is already connected to this account.',
  linkConflict: 'This Twitch account is already connected to another account.',
  disconnectEmailRequired: 'Add and verify an email before disconnecting Twitch.',
  disconnectSignInRequired: 'Sign in before disconnecting Twitch.',
  disconnectUnavailable: 'Twitch could not be disconnected. Try again.',

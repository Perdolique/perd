  ...
  <PerdCard :class="$style.component">
    <div :class="$style.header">
      ...
      <div :class="$style.aside">
        <div :class="$style.modeToggle" role="group" aria-label="Packing list detail mode">
          <button
            type="button"
...
<script lang="ts" setup>
  ...
  import type { PackingListDetailMode } from '~/types/packing'
  import PerdCard from '~/components/PerdCard.vue'
  import PackingListIdentity from '~/components/packing-lists/PackingListIdentity.vue'
  ...
  type Emits = (event: 'update:mode', mode: PackingListDetailMode) => void
  ...
  function emitModeUpdate(mode: PackingListDetailMode) {

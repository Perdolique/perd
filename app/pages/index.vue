...
<style module>
  ...
  .primaryAction {
    ...
    &:focus-visible {
      box-shadow: var(--shadow-focus), var(--shadow-large);
    }
  ...
  .primaryIcon {
    ...
    background: color-mix(in oklch, var(--color-accent-contrast) 14%, transparent);
  ...
  .primaryMeta {
    color: color-mix(in oklch, var(--color-accent-contrast) 78%, transparent);

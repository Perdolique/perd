/* eslint-disable */
// Generated by Wrangler by running `wrangler types server/types/worker-configuration.d.ts` (hash: edc19728ac1cf769519b1b09284a8f20)
// Runtime types generated with workerd@1.20260911.1 2026-09-13 nodejs_compat
interface __BaseEnv_Env {
	EMAIL: SendEmail;
	PASSKEY_RATE_LIMITER: RateLimit;
	PHOTO_SUBMISSION_RATE_LIMITER: RateLimit;
	PHOTO_SUBMISSION_TURNSTILE_RATE_LIMITER: RateLimit;
	ITEM_SUBMISSION_RATE_LIMITER: RateLimit;
	GUEST_SESSION_RATE_LIMITER: RateLimit;
	EMAIL_REGISTRATION_RATE_LIMITER: RateLimit;
	EMAIL_VERIFICATION_RATE_LIMITER: RateLimit;
	EMAIL_SIGN_IN_RATE_LIMITER: RateLimit;
	PASSWORD_RECOVERY_RATE_LIMITER: RateLimit;
	TWITCH_OAUTH_RATE_LIMITER: RateLimit;
	IMAGES: ImagesBinding;
	NUXT_PASSKEYS_ORIGIN: "https://metsik.app" | "https://staging.metsik.app" | "http://localhost:8888";
	NUXT_OAUTH_TWITCH_CLIENT_ID?: "76z9coffucmezuwxx68iurur0vnigy" | "58vwcqcpjpf7iz530v11z3sovtgfc5";
	NUXT_PUBLIC_TURNSTILE_SITE_KEY: "0x4AAAAAAEntzYh6QUh27Ji_" | "1x00000000000000000000AA";
	NUXT_TURNSTILE_HOSTNAMES: "metsik.app" | "staging.metsik.app" | "localhost,127.0.0.1";
	PHOTO_SUBMISSION_ENVIRONMENT: "production" | "staging" | "development";
	NUXT_PUBLIC_EMAIL_REGISTRATION_ENABLED: "true";
	NUXT_EMAIL_REGISTRATION_ORIGIN: "https://metsik.app" | "https://staging.metsik.app" | "http://localhost:3000";
	NUXT_EMAIL_REGISTRATION_ENVIRONMENT: "production" | "staging" | "development";
	NUXT_DATABASE_URL: string;
	NUXT_OAUTH_TWITCH_CLIENT_SECRET: string;
	NUXT_SESSION_SECRET: string;
	NUXT_TURNSTILE_SECRET: string;
	NUXT_EMAIL_REGISTRATION_STAGING_RECIPIENT?: string;
}
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		...
		TWITCH_OAUTH_RATE_LIMITER: RateLimit;
		IMAGES: ImagesBinding;
		NUXT_PASSKEYS_ORIGIN: "https://metsik.app";
		NUXT_OAUTH_TWITCH_CLIENT_ID: "76z9coffucmezuwxx68iurur0vnigy";
		NUXT_PUBLIC_TURNSTILE_SITE_KEY: "0x4AAAAAAEntzYh6QUh27Ji_";
		NUXT_TURNSTILE_HOSTNAMES: "metsik.app";
		PHOTO_SUBMISSION_ENVIRONMENT: "production";
		NUXT_PUBLIC_EMAIL_REGISTRATION_ENABLED: "true";
		NUXT_EMAIL_REGISTRATION_ORIGIN: "https://metsik.app";
		NUXT_EMAIL_REGISTRATION_ENVIRONMENT: "production";
		NUXT_DATABASE_URL: string;
		NUXT_OAUTH_TWITCH_CLIENT_SECRET: string;
		NUXT_SESSION_SECRET: string;
		NUXT_TURNSTILE_SECRET: string;
	...
	interface StagingEnv {
		...
		TWITCH_OAUTH_RATE_LIMITER: RateLimit;
		IMAGES: ImagesBinding;
		NUXT_PASSKEYS_ORIGIN: "https://staging.metsik.app";
		NUXT_OAUTH_TWITCH_CLIENT_ID: "58vwcqcpjpf7iz530v11z3sovtgfc5";
		NUXT_PUBLIC_TURNSTILE_SITE_KEY: "0x4AAAAAAEntzYh6QUh27Ji_";
		NUXT_TURNSTILE_HOSTNAMES: "staging.metsik.app";
		PHOTO_SUBMISSION_ENVIRONMENT: "staging";
		NUXT_PUBLIC_EMAIL_REGISTRATION_ENABLED: "true";
		NUXT_EMAIL_REGISTRATION_ORIGIN: "https://staging.metsik.app";
		NUXT_EMAIL_REGISTRATION_ENVIRONMENT: "staging";
		NUXT_DATABASE_URL: string;
		NUXT_EMAIL_REGISTRATION_STAGING_RECIPIENT: string;
		NUXT_OAUTH_TWITCH_CLIENT_SECRET: string;
		NUXT_SESSION_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NUXT_PASSKEYS_ORIGIN" | "NUXT_OAUTH_TWITCH_CLIENT_ID" | "NUXT_PUBLIC_TURNSTILE_SITE_KEY" | "NUXT_TURNSTILE_HOSTNAMES" | "PHOTO_SUBMISSION_ENVIRONMENT" | "NUXT_PUBLIC_EMAIL_REGISTRATION_ENABLED" | "NUXT_EMAIL_REGISTRATION_ORIGIN" | "NUXT_EMAIL_REGISTRATION_ENVIRONMENT" | "NUXT_DATABASE_URL" | "NUXT_OAUTH_TWITCH_CLIENT_SECRET" | "NUXT_SESSION_SECRET" | "NUXT_TURNSTILE_SECRET" | "NUXT_EMAIL_REGISTRATION_STAGING_RECIPIENT">> {}
}
